# Personal AI Agent Platform — Deployment Plan (v4)

**Status:** Phase 1 (host preparation) complete — entering Phase 2 (Ollama + Qwen benchmark)
**Date:** 2026-08-18
**Country:** Brazil
...
### Phase 2 — Ollama + Qwen benchmark — **next**
...
**Next action: Phase 2 — Ollama + Qwen benchmark.**

Phase 1 is complete: `/mnt/data` inspected and cleared for RED data, Docker confirmed healthy, firewall/static-IP/power/network decisions made (commands in sections 19 and 24, ready to run on the host), and the platform's storage tree defined.

Now: **install and benchmark Ollama + Qwen (Phase 2).** Only after measuring actual performance on the confirmed 4 GB VRAM / 16 GB RAM / 2-core CPU envelope should the final Qwen model size be chosen.
